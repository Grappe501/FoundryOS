...
export const INCOMING_WORLDS: IncomingWorld[] = [
  {
    ...
    note: 'Super-node world — links AI Builder · FI · Public Speaking · Civic; prioritize after 040A–F',
  },
  {
    rank: 2,
  ...
  },
  {
    ...
    note: 'Comparative religion — no apologetics, no anti-religious framing; student-safe; lifetime depth',
  },
  {
    rank: 5,
    slug: 'country-music',
    name: 'Country Music',
    frame: 'Understand the Genre as Culture and Craft',
    tier: 'Passion',
    status: 'idea',
    outcome: 'Become a serious country music listener and collector',
    score: 80,
    acquisition_avenues: ['seo', 'youtube', 'community', 'tiktok'],
    note: 'Artists, scenes, songwriting craft, live culture — community-native retention',
  },
  {
    rank: 6,
