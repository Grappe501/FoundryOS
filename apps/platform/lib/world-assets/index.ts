...
export const WORLD_ASSETS: Record<string, WorldAssetDirection> = {
  ...
  'public-speaking': {
    ...
    heroGradient: 'linear-gradient(135deg, #12100A 0%, var(--foundry-primary-bg-subtle) 50%, #100E0A 100%)',
    heroBorder: 'var(--foundry-primary-border-dim)',
  ...
  bourbon: {
    slug: 'bourbon',
    heroGradient: 'linear-gradient(135deg, #141008 0%, var(--foundry-primary-bg-subtle) 40%, #0F0C08 100%)',
    heroBorder: 'var(--foundry-primary-border-dim)',
