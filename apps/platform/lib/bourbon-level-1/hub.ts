...
export const LEVEL_1_TOOLS: Level1Tool[] = [
  ...
  { slug: 'compare', href: '/bourbon/compare', title: 'Compare Any Two', hook: 'Bottles, producers, or whiskey categories side-by-side', icon: '⚖', priority: 1.8, category: 'investigate' },
  { slug: 'whiskey-map', href: '/bourbon/whiskey-map', title: 'American Whiskey Map', hook: 'Bourbon vs rye vs Tennessee vs corn — category literacy', icon: '🗺', priority: 1.85, category: 'investigate' },
  ...
  { slug: 'bottles-db', href: '/bourbon/bottles', title: 'Bottle Progression', hook: '55 bottles · 13 craft houses — majors, rye & Tennessee depth', icon: '🥃', priority: 2.7, category: 'investigate' },
  ...
  { slug: 'producers', href: '/bourbon/producers', title: 'Producer Atlas', hook: '24 houses — majors, craft campuses, Tennessee', icon: '🏭', priority: 18, category: 'explore' },
