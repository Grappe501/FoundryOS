...
export function buildPlatformSearchIndex(): SearchIndexEntry[] {
  ...
  const level1Tools = [
    ...
    { href: '/bourbon/shelf-builder', title: 'Shelf Builder', summary: 'Starter, advanced, collector shelves — Level 1 budget builder' },
    { href: '/bourbon/level-3', title: 'Level 3 — Shelf Builder', summary: '12 themed shelves, price ladder, gap analysis, shelf defense' },
    { href: '/bourbon/level-4', title: 'Level 4 — Connoisseur', summary: 'Label decoder, Compare Five lab, DSP hunts, process labs' },
    { href: '/bourbon/label-decoder', title: 'Label Decoder', summary: '8 drills — predict pour before X-Ray reveal' },
    { href: '/bourbon/compare-five-lab', title: 'Compare Five Lab', summary: '12 connoisseur presets with hypothesis discipline' },
    { href: '/bourbon/dsp-scavenger', title: 'DSP Scavenger Hunt', summary: 'Match bottles to distillery numbers' },
    { href: '/bourbon/themed-shelf', title: 'Themed Shelf', summary: 'Curated shelf themes with bottle roles' },
