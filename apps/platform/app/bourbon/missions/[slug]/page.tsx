...
export default async function BourbonMissionPage({ params }: Props) {
  ...
  return (
    <section style={{ marginTop: 16 }}>
      <Link href="/bourbon/missions" style={{ color: '#6B6B70', fontSize: 13, textDecoration: 'none' }}>← All missions</Link>
      ...
      <WorldMissionRunner mission={mission} portfolioKey={BOURBON_PORTFOLIO_KEY} basePath="/bourbon" pathSlug="bourbon" portfolioLabel={BOURBON_PORTFOLIO_LABEL} />
    </section>
  );
}
