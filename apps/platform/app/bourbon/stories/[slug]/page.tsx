...
export default async function BourbonStoryPage({ params }: Props) {
  ...
  return (
    <section style={{ marginTop: 16 }}>
      ...
      <p style={{ color: '#C8A96E', fontSize: 14, marginTop: 8 }}>{story.subtitle}</p>
      ...
      {story.relatedProducer && (
        <Link href={`/bourbon/producers/${story.relatedProducer}`} style={{ display: 'inline-block', marginTop: 28, color: '#C8A96E', fontSize: 14 }}>
