...
export default function OperatorEventsPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: 'var(--foundry-bg)', color: 'var(--foundry-text)', padding: '2rem', maxWidth: 720, margin: '0 auto' }}>
      ...
      <Link href="/operator/discovery" style={{ color: 'var(--foundry-text-faint)', fontSize: 13, marginLeft: 16 }}>Discovery</Link>
      <Link href="/operator/collections" style={{ color: 'var(--foundry-text-faint)', fontSize: 13, marginLeft: 16 }}>Collections</Link>
      ...
      <section style={{ marginTop: 20, padding: 16, background: '#0F1218', border: '1px solid #2A2A3A', borderRadius: 8 }}>
        <p style={{ color: 'var(--foundry-text-faint)', fontSize: 12, margin: 0 }}>Principle</p>
      ...
      <section style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
        <div style={{ padding: 14, background: 'var(--foundry-surface)', borderRadius: 8 }}>
          <p style={{ color: 'var(--foundry-text-faint)', fontSize: 11, margin: 0 }}>Definitions</p>
          <p style={{ color: 'var(--foundry-text)', fontSize: 22, marginTop: 6 }}>{allEventDefinitions().length}</p>
        </div>
        <div style={{ padding: 14, background: 'var(--foundry-surface)', borderRadius: 8 }}>
          <p style={{ color: 'var(--foundry-text-faint)', fontSize: 11, margin: 0 }}>Validation</p>
          <p style={{ color: validation.ok ? 'var(--foundry-success)' : '#8B4545', fontSize: 14, marginTop: 6 }}>{validation.ok ? 'PASS' : 'FAIL'}</p>
        </div>
      </section>
