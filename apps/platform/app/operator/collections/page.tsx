...
export default function OperatorCollectionsPage() {
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#08080A', color: '#E8E8EC', padding: '2rem', maxWidth: 720, margin: '0 auto' }}>
      ...
      <Link href="/operator/discovery" style={{ color: '#6B6B70', fontSize: 13, marginLeft: 16 }}>Discovery Graph</Link>
      <Link href="/collections" style={{ color: '#6B6B70', fontSize: 13, marginLeft: 16 }}>PASS-012 Assets</Link>
      ...
      <section style={{ marginTop: 20, padding: 16, background: '#0F1218', border: '1px solid #2A2A3A', borderRadius: 8 }}>
        <p style={{ color: '#6B6B70', fontSize: 12, margin: 0 }}>Loop</p>
