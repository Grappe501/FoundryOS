  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#08080A', color: '#E8E8EC', padding: '2rem', maxWidth: 1000, margin: '0 auto' }}>
      ...
      <section style={{ marginTop: 28, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <div style={{ color: '#C8A96E', fontSize: 13 }}>North Star</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: 12, marginTop: 16 }}>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.active_paths}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Active Paths</div></div>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.users_on_paths}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Users on Paths</div></div>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.academy_graduates}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Academy Graduates</div></div>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.community_leaders}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Community Leaders</div></div>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.expert_contributors}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Expert Contributors</div></div>
          <div><div style={{ fontSize: 22, color: '#C8A96E' }}>{northStar.club_hosts}</div><div style={{ fontSize: 11, color: '#6B6B70' }}>Club Hosts</div></div>
        </div>
      </section>

      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Expert Development Pillars</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Bourbon Paths ({bourbonPaths.length})</h2>
        {bourbonPaths.map((p) => (
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>All Paths ({activePaths.length} active / {northStar.total_paths_defined} defined)</h2>
