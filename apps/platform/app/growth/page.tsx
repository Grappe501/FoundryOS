...
export default async function GrowthOsPage() {
  ...
  return (
    ...
    >
      ...
      {business && (
        <section style={{ marginTop: 24, padding: 24, background: 'var(--foundry-surface)', border: '1px solid var(--foundry-primary-border-dim)', borderRadius: 8 }}>
          <h2 style={{ fontSize: 14, color: 'var(--foundry-primary)', margin: 0 }}>Business metrics — PASS-029</h2>
          <p style={{ color: 'var(--foundry-text-faint)', fontSize: 12, marginTop: 8 }}>Build metrics below · business metrics first.</p>
          ...
          <p style={{ marginTop: 16, fontSize: 12 }}>
            <Link href="/operator/business" style={{ color: 'var(--foundry-success)' }}>Founder dashboard →</Link>
            {' · '}
      ...
      <section style={{ marginTop: 24, padding: 20, background: 'var(--foundry-surface)', border: '1px solid var(--foundry-primary-border-dim)', borderRadius: 8 }}>
        ...
        <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: 12 }}>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-primary)' }}>{launchCost.avg_hours_completed ?? '—'}h</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Avg completed (hand-built)</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>{launchCost.avg_factory_hours ?? '—'}h</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Avg factory launch</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>{launchCost.domains_generated}</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Domains generated</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>{launchCost.domains_activated}</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Domains activated</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>&lt; {launchCost.factory_target_hours}h</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Factory target</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: launchCost.avg_automation_pct >= 80 ? 'var(--foundry-success)' : 'var(--foundry-primary)' }}>
              {launchCost.avg_automation_pct}%
            </div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Automation (target {launchCost.factory_automation_target_pct}%+)</div>
          </div>
        </div>
        <div style={{ marginTop: 20 }}>
          {launchCostDetail.entries.map((e) => (
            <div key={e.slug} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--foundry-border-subtle)', fontSize: 13 }}>
              <span style={{ color: 'var(--foundry-text)' }}>{e.displayName}</span>
        ...
        <p style={{ color: 'var(--foundry-text-dim)', fontSize: 11, marginTop: 12 }}>
          ...
          <code style={{ color: 'var(--foundry-text-faint)' }}>npm run audit:worlds</code>
        </p>
      </section>

      <section style={{ marginTop: 24, padding: 20, background: 'var(--foundry-surface)', border: '1px solid #3A4A6A', borderRadius: 8 }}>
        ...
        <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: 12 }}>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            ...
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Avg depth score</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>{worldDepth.avg_consumer_readiness_pct}%</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Consumer readiness</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-text)' }}>{worldDepth.total_academy_lessons}</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Academy lessons</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-text)' }}>{worldDepth.total_glossary_terms}</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Glossary terms</div>
          </div>
        </div>
        <div style={{ marginTop: 20 }}>
          {worldDepthDetail.rows.map((r) => (
            <div key={r.slug} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--foundry-border-subtle)', fontSize: 13 }}>
              <span style={{ color: 'var(--foundry-text)' }}>{r.displayName}</span>
              <span style={{ color: 'var(--foundry-text-muted)' }}>
        ...
        <p style={{ color: 'var(--foundry-text-dim)', fontSize: 11, marginTop: 12 }}>
          <code style={{ color: 'var(--foundry-text-faint)' }}>npm run audit:depth</code>
        </p>
      </section>

      <section style={{ marginTop: 24, padding: 20, background: 'var(--foundry-surface)', border: '1px solid #2A4A3A', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: 'var(--foundry-success)', margin: 0 }}>World Experience Score — PASS-032B</h2>
        <p style={{ color: 'var(--foundry-text-muted)', fontSize: 13, marginTop: 12 }}>
          Hero · Mission 1 · tools · visual · community · copy · return hook. Target ≥ {worldExperience.target_score}% before beta.
        </p>
        <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: 12 }}>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-success)' }}>{worldExperience.avg_experience_score}%</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Avg experience score</div>
          </div>
          <div style={{ padding: 14, background: 'var(--foundry-surface-raised)', borderRadius: 6 }}>
            <div style={{ fontSize: 22, fontWeight: 300, color: 'var(--foundry-text)' }}>{worldExperience.worlds_ready}/{worldExperience.worlds}</div>
            <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>Worlds beta-ready</div>
          </div>
        </div>
        <div style={{ marginTop: 20 }}>
          {worldExperienceDetail.rows.map((r) => (
            <div key={r.slug} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--foundry-border-subtle)', fontSize: 13 }}>
              <span style={{ color: 'var(--foundry-text)' }}>{r.displayName}</span>
              <span style={{ color: r.status === 'READY' ? 'var(--foundry-success)' : 'var(--foundry-primary)' }}>
        ...
        <p style={{ color: 'var(--foundry-text-dim)', fontSize: 11, marginTop: 12 }}>
          <code style={{ color: 'var(--foundry-text-faint)' }}>npm run audit:experience</code> · see docs/WORLD_UX_EMOTIONAL_AUDIT.md
        </p>
      </section>

      <section style={{ marginTop: 24, padding: 20, background: 'var(--foundry-surface)', border: '1px solid #2A4A4A', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: 'var(--foundry-success)', margin: 0 }}>Domain Readiness Score — PASS-027</h2>
        <p style={{ color: 'var(--foundry-text-muted)', fontSize: 13, marginTop: 12 }}>
        ...
        <div style={{ marginTop: 16 }}>
          {(transformationAnalytics?.domain_readiness ?? worldDepthDetail.rows.map((r) => ({
            ...
            <div key={d.slug} style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8, padding: '10px 0', borderBottom: '1px solid var(--foundry-border-subtle)', fontSize: 12 }}>
              <span style={{ color: 'var(--foundry-text)', minWidth: 140 }}>{d.label}</span>
              <span style={{ color: 'var(--foundry-text-muted)' }}>
                {DOMAIN_READINESS_LABELS.depth} {d.depth}% · {DOMAIN_READINESS_LABELS.engagement} {d.engagement}% · {DOMAIN_READINESS_LABELS.retention} {d.retention}% · {DOMAIN_READINESS_LABELS.conversion} {d.conversion}% · <strong style={{ color: 'var(--foundry-success)', fontWeight: 400 }}>{DOMAIN_READINESS_LABELS.readiness} {d.readiness}%</strong>
              </span>
            </div>
          ))}
        </div>
      ...
      <section style={{ marginTop: 24, padding: 20, background: 'var(--foundry-surface)', border: '1px solid var(--foundry-success-bg)', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: 'var(--foundry-success)', margin: 0 }}>Exceptional Domains — Jan 2027 target: 5 + factory for 100</h2>
        <p style={{ color: 'var(--foundry-text-muted)', fontSize: 13, marginTop: 12 }}>
          Active ≠ built. Full transformation stack operational: {ACTIVE_DOMAIN_CRITERIA.join(' · ')}
        </p>
        <p style={{ color: 'var(--foundry-text)', fontSize: 22, fontWeight: 300, marginTop: 12 }}>
          {growth.active_domains} active · {growth.domains_built} built · {Math.round(growth.domain_activation_rate * 100)}% activation
        </p>
        <p style={{ color: 'var(--foundry-text-muted)', fontSize: 13, marginTop: 12 }}>
          Public catalog:{' '}
          <Link href="/explore" style={{ color: 'var(--foundry-success)' }}>
            {growth.public_catalog_paths || countExploreCatalogPaths()} paths listed
          </Link>
          {' · '}
          <Link href="/course-catalog" style={{ color: 'var(--foundry-text-faint)', fontSize: 12 }}>
            operator view
          </Link>
        </p>
      </section>
        ...
        >
          {stats.map((s) => (
            ...
            >
              ...
              <div style={{ fontSize: 11, color: 'var(--foundry-text-faint)', marginTop: 4 }}>{s.label}</div>
            </div>
          ))}
        </div>
      ...
      <section style={{ marginTop: 24, padding: 24, background: 'var(--foundry-surface)', borderRadius: 8 }}>
        ...
        <div style={{ marginTop: 16 }}>
          {REVENUE_MILESTONES.map((m) => (
            ...
            >
              <span style={{ color: 'var(--foundry-text)' }}>{m.period}</span>
      ...
      <section style={{ marginTop: 24, padding: 24, background: 'var(--foundry-surface-raised)', borderRadius: 8 }}>
        ...
        <p style={{ color: 'var(--foundry-text)', fontSize: 14, marginTop: 12, lineHeight: 1.8 }}>
      ...
      <section style={{ marginTop: 24, padding: 24, background: 'var(--foundry-surface)', borderRadius: 8 }}>
        ...
        <p style={{ color: 'var(--foundry-text)', fontSize: 13, marginTop: 16 }}>
          {SEO_PAGE_TYPES.join(' · ')}
        </p>
      </section>
      ...
      <section style={{ marginTop: 32, fontSize: 12, color: 'var(--foundry-text-dim)' }}>
        <p>
          Marketing workspace: <code style={{ color: 'var(--foundry-text-faint)' }}>marketing/</code> · Docs:{' '}
          <Link href="/" style={{ color: 'var(--foundry-text-faint)' }}>
            docs/GROWTH_OS.md
          </Link>
        </p>
        <p style={{ marginTop: 8 }}>
