...
export default function LaunchFactoryPage() {
  ...
  return (
    ...
    >
      ...
      <section style={{ marginTop: 28, padding: 24, background: '#0F0F12', border: '1px solid #2A4A2A', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#6B9B6B', margin: 0 }}>Domain Launch Velocity</h2>
        ...
        <div style={{ display: 'flex', gap: 32, marginTop: 16, flexWrap: 'wrap' }}>
          <div>
            <p style={{ color: '#6B6B70', fontSize: 11, margin: 0 }}>Active domains</p>
            <p style={{ color: '#E8E8EC', fontSize: 28, fontWeight: 300, margin: '4px 0 0' }}>
              {velocity.active_count}
            </p>
          </div>
          <div>
            <p style={{ color: '#6B6B70', fontSize: 11, margin: 0 }}>Scaffolded</p>
            <p style={{ color: '#E8E8EC', fontSize: 28, fontWeight: 300, margin: '4px 0 0' }}>
      ...
      <section style={{ marginTop: 24, padding: 24, background: '#111114', borderRadius: 8, border: '1px solid #2A2520' }}>
        ...
        <p style={{ color: '#8A8A8E', fontSize: 13, marginTop: 12, lineHeight: 1.7 }}>
          ...
          <strong style={{ color: '#6B9B6B', fontWeight: 500 }}>Active Domain</strong> with real users.
        </p>
        <p style={{ color: '#6B6B70', fontSize: 12, marginTop: 12, fontFamily: 'monospace' }}>
