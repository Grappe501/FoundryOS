...
export default function TransformationGraphPage() {
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#08080A', color: '#E8E8EC', padding: '2rem', maxWidth: 1000, margin: '0 auto' }}>
      ...
      <p style={{ color: '#C8A96E', fontSize: 15, marginTop: 8 }}>{COMPANION_PRINCIPLE.headline}</p>
      ...
      <section style={{ marginTop: 24, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>PASS-010 Success</h2>
      ...
      <section style={{ marginTop: 20, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 12 }}>
        {PLATFORM_COMPARISON.map((p) => (
          <div key={p.platform} style={{ padding: 14, background: '#0F0F12', borderRadius: 8, border: p.platform === 'Foundry' ? '1px solid #2A2520' : '1px solid #1A1A1E' }}>
            <div style={{ color: p.platform === 'Foundry' ? '#C8A96E' : '#8A8A8E', fontSize: 12 }}>{p.platform}</div>
      ...
      <section style={{ marginTop: 28, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 }}>
        {Object.values(GRAPH_COMPARISON).map((g) => (
          <div key={g.name} style={{ padding: 16, background: '#0F0F12', borderRadius: 8, border: g.name === 'Foundry' ? '1px solid #2A2520' : '1px solid #1A1A1E' }}>
            <div style={{ color: g.name === 'Foundry' ? '#C8A96E' : '#8A8A8E', fontSize: 13 }}>{g.name}</div>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Human Development Loop</h2>
      ...
      <section style={{ marginTop: 32, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>PASS-010 Demonstration Goal</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Three Compounding Datasets</h2>
        ...
        <p style={{ color: '#C8A96E', fontSize: 11, marginTop: 12 }}>{JOURNEY_DATASET_PRINCIPLE}</p>
      </section>

      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Daily Loop</h2>
        {DAILY_LOOP.map((d) => (
          <div key={d.rhythm} style={{ padding: '10px 0', borderBottom: '1px solid #1A1A1E', fontSize: 12 }}>
            <span style={{ color: '#E8E8EC' }}>{d.rhythm}</span>
            <span style={{ color: '#C8A96E' }}> — {d.question}</span>
          </div>
        ))}
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{FOUNDRY_COMPASS.headline}</h2>
      ...
      <section style={{ marginTop: 32, padding: 16, background: '#0F0F12', borderRadius: 8, border: '1px solid #1A1A1E' }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>Long-Term Test</h2>
        <p style={{ color: '#8B4545', fontSize: 12, marginTop: 12, textDecoration: 'line-through' }}>{LONG_TERM_TEST.not}</p>
        <p style={{ color: '#C8A96E', fontSize: 14, marginTop: 8 }}>{LONG_TERM_TEST.is}</p>
      </section>

      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Graph Flow</h2>
        <p style={{ color: '#8A8A8E', fontSize: 14, marginTop: 8 }}>{TRANSFORMATION_GRAPH_FLOW}</p>
      </section>

      <section style={{ marginTop: 32, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>Agency Principle</h2>
        ...
        {AGENCY_METRIC_EXAMPLES.map((e) => (
          <div key={e.domain} style={{ padding: '8px 0', borderBottom: '1px solid #1A1A1E', fontSize: 12 }}>
            ...
            <div style={{ color: '#C8A96E', marginTop: 2 }}>✓ {e.good_metric}</div>
          </div>
        ))}
      </section>

      <section style={{ marginTop: 32, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>Pass Gate (PASS-009)</h2>
      ...
      <section style={{ marginTop: 16, padding: 20, background: '#0F0F12', border: '1px solid #2A2520', borderRadius: 8 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E', margin: 0 }}>Pass Gate (PASS-010)</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{PASS_010_TITLE}</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Relationship Weighting</h2>
        {EXAMPLE_WEIGHTED_RELATIONSHIPS.map((r) => (
          <div key={`${r.source}-${r.target}`} style={{ padding: '10px 0', borderBottom: '1px solid #1A1A1E', fontSize: 12 }}>
            ...
            <span style={{ color: '#C8A96E', marginLeft: 8 }}>weight {r.weight}</span>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Transformation Analytics</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{TRANSFORMATION_VELOCITY_LABEL}</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{TRANSFORMATION_MOMENTUM_LABEL}</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{PASS_010_REFLECTION_ENGINE}</h2>
        ...
        <p style={{ color: '#C8A96E', fontSize: 12, marginTop: 12 }}>{TRANSFORMATION_INTELLIGENCE_LOOP_FLOW}</p>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{NEXT_ACTION_ENGINE_LABEL}</h2>
        ...
        {EXAMPLE_NEXT_ACTIONS.map((a) => (
          <div key={a.path_slug} style={{ marginTop: 12, padding: 16, background: '#0F0F12', borderRadius: 8, border: '1px solid #2A2520' }}>
            ...
            <div style={{ color: '#C8A96E', fontSize: 14, marginTop: 8 }}>Next Highest-Value Action: {a.recommended_action}</div>
        ...
        <p style={{ color: '#C8A96E', fontSize: 12, marginTop: 16 }}>{WHY_NEXT_BEST_STEP_QUESTION}</p>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>Transformation Stories</h2>
        ...
        {EXAMPLE_TRANSFORMATION_STORY.beats.map((b) => (
          <div key={b.year} style={{ padding: '6px 0', fontSize: 12, color: '#8A8A8E' }}>
            <span style={{ color: '#C8A96E' }}>{b.year}</span> — {b.event}
          </div>
        ))}
      </section>

      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{TRANSFORMATION_PATTERNS_PRINCIPLE.headline}</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{TRANSFORMATION_INTELLIGENCE.headline}</h2>
        <p style={{ color: '#C8A96E', fontSize: 14 }}>{TRANSFORMATION_INTELLIGENCE.definition}</p>
        <p style={{ color: '#6B6B70', fontSize: 11, marginTop: 8 }}>{TRANSFORMATION_INTELLIGENCE.dataset}</p>
      </section>

      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{PASS_011_TITLE}</h2>
      ...
      <section style={{ marginTop: 32 }}>
        <h2 style={{ fontSize: 14, color: '#C8A96E' }}>{FOUNDRY_ORGANIZATIONS_VISION.headline}</h2>
