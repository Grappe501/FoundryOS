import { CIVIC_ENGAGEMENT_PLAYGROUND_LABS } from '../../../lib/civic-engagement-world-meta';

export default function CivicEngagementPlaygroundPage() {
  return (
    <section style={{ marginTop: 16 }}>
      <h1 style={{ fontWeight: 300, fontSize: '2rem', margin: 0 }}>Playground</h1>
      {CIVIC_ENGAGEMENT_PLAYGROUND_LABS.map((lab) => (
