...
export default function CivicEngagementVerticalPage() {
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#08080A', color: '#E8E8EC', padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
      ...
      <p style={{ color: '#6B9B6B', fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', marginTop: 16 }}>
      ...
      <section style={{ marginTop: 32, padding: 24, background: '#0F0F12', borderRadius: 8, border: '1px solid #2A4A2A' }}>
        <h2 style={{ fontSize: 14, color: '#6B9B6B', margin: 0 }}>Factory layers</h2>
